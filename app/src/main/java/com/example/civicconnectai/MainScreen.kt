...
// Pass this up from Home
    ...
    Scaffold(
        ...
        Surface(modifier = Modifier.padding(paddingValues)) {
            when (selectedTab) {
                "Home" -> HomeScreen(reportIssueScreen = reportIssueScreen, onIssueClick = onIssueClick)
                "Map" -> MapScreen(reportIssueScreen = reportIssueScreen) // You need to create this function
